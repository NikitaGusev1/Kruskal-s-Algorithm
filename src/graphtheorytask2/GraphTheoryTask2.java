package graphtheorytask2;
import java.util.Arrays;
import java.util.Scanner;
public class GraphTheoryTask2 {
static class Graph 
{ 
...
//        System.out.println("This is an edge for cycle forming");
//            System.out.println(discard[0].src+" -- " +  
//                   discard[0].dest+" == " + discard[0].weight);
    }
}
